...
def train_model(model_num, dataset_filename, output_filename, batch_size, num_epochs):
    ...
    if model_num == MNIST_MODEL_NUM:
        train_mnist.train_model(dataset_filename, output_filename, batch_size=batch_size, num_epochs=num_epochs)
    else:
...
if __name__ == '__main__':
    ...
    train_model(args.model_num, args.dataset_filename, args.output_filename, args.batch_size, args.num_epochs)
